        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    ...
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">Sila daftar akaun anda
                        <br> untuk meneruskan <br /> penggunaan system MyISM</div>
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div
                    ...
                    <div class="intro-x mt-2 text-gray-500 xl:hidden text-center">Sila daftar akaun anda untuk
                        meneruskan <br /> penggunaan system MyISM</div>
                    ...
                    <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                        <button id="btn-login" class="btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">Log
                            Masuk</button>
                    </div>
                </div>
            </div>
