...
@section('subhead')
<title>Laporan Penceramah Kursus | MyISM</title>
@endsection
    ...
    <div class="col-span-12">
        <div class="box p-5 intro-y">
            ...
            <div class="text-center">
                <h2 class="intro-x font-bold text-2xl xl:text-3xl text-center mt-5">Laporan Penceramah Kursus</h2>
            </div>
                ...
                <table class="table-fixed w-full">
                    <thead>
                        <tr class="bg-gray-300">
                            ...
                            <th class="w-2/12 py-3 border-2 border-gray-400">Jumlah Kredit Jam</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="bg-none">
                            <td class="text-center py-3 border-2 border-gray-400">1</td>
                            <td class="text-center py-3 border-2 border-gray-400">Ahmad</td>
                            ...
                            <td class="text-center py-3 border-2 border-gray-400">6</td>
                        </tr>
                        <tr class="bg-gray-300">
                            ...
                            <td class="text-center py-3 border-2 border-gray-400">15/12/2021</td>
                            <td class="text-center py-3 border-2 border-gray-400">8</td>
                        </tr>
                        <tr class="bg-none">
                        ...
                        <tr class="">
                            <td colspan="5" class="text-right px-2 py-3 border-2 border-gray-400 font-bold">
                                JUMLAH JAM
                            </td>
