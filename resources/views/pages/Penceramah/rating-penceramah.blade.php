...
@section('subcontent')
<h2 class="intro-x font-bold text-2xl xl:text-3xl text-center mt-5">Senarai Rating Penceramah</h2>
            ...
            <tbody>
                ...
                <tr class={{$rating['id'] % 2 == 0 ? 'bg-gray-300' : 'bg-none'}}>
                    ...
                    <td class="text-center py-3 border-2 border-gray-400">
                        ...
                        <a title="Delete" class="btn btn-danger p-1 delete-rating" id="{{ $rating['id'] }}" data-url="rating-penceramah">
