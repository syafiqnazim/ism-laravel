...
@section('subcontent')
<h2 class="intro-x font-bold text-2xl xl:text-3xl text-center mt-5">Senarai Credit Penceramah</h2>
        ...
        <table class="table-fixed w-full">
            <thead>
                <tr class="bg-gray-300">
                    ...
                    <th class="w-2/12 py-3 border-2 border-gray-400">Credit</th> 
            ...
            <tbody>
                ...
                <tr class={{$penceramah['id'] % 2 == 0 ? 'bg-gray-300' : 'bg-none'}}>
                    ...
                    <td class="text-center py-3 border-2 border-gray-400">{{ $penceramah['credit'] }}</td> 
                ...
                @include('../pages/Penceramah/edit-credit-penceramah-modal', [$loop->index, $penceramah])
...
@include('../pages/Penceramah/tambah-penceramah-modal')
@endsection