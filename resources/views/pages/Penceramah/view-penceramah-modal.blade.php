...
<div id="view-penceramah-{{ $loop->index }}" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog w-1/2 mt-10">
        <div class="modal-content">
            {{-- <form class="tambah-penceramah-form"> --}}
            <div class="modal-body p-0">
                <div class="p-5 text-center">
                    <h5 class="intro-x font-bold text-2xl xl:text-3xl text-center mb-6">Lihat Penceramah</h5>
                    <div class="grid grid-cols-4 gap-2 mb-6">
                        <div class="col-span-1 input-form">
                            <label for="register-form-1" class="form-label w-full flex flex-col sm:flex-row">
                                Sektor
                            </label>
                            <input id="sector" class="form-control" readonly value="{{ $penceramah['sector'] }}">
                        </div>
                        <div class="col-span-1 input-form">
                            <label for="register-form-1" class="form-label w-full flex flex-col sm:flex-row">
                                Gelaran
                            </label>
                            <input id="title" class="form-control" readonly value="{{ $penceramah['title'] }}">
                        </div>
                        <div class="col-span-2 input-form">
                            <label for="register-form-1" class="form-label w-full flex flex-col sm:flex-row">
                                Nama
                            </label>
                            <input id="name" class="form-control" readonly value="{{ $penceramah['name'] }}">
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-2 mb-6">
                        <div class="col-span-1 input-form">
                            ...
                            <input id="ic_number" class="form-control" readonly value="{{ $penceramah['ic_number'] }}">
                        </div>
                        <div class="col-span-1 input-form">
                            <label for="register-form-1" class="form-label w-full flex flex-col sm:flex-row">
                                Jantina
                            ...
                            <div class="flex flex-col items-start">
                                <div>
                                    <input type="radio" id="lelaki"
                                        {{ $penceramah['gender'] == "Lelaki" ? 'checked' : '' }}>
                    ...
                    <div class="grid grid-cols-2 gap-2 mb-6">
                        ...
                        <div class="col-span-1 input-form">
                            ...
                            <input id="bank_name" class="form-control" readonly value="{{ $penceramah['bank_name'] }}">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-2 mb-6">
                        <div class="col-span-1 input-form">
                            ...
                            <input id="email" class="form-control" readonly value="{{ $penceramah['email'] }}">
                        </div>
                        <div class="col-span-1 input-form">
                            <label for="register-form-1" class="form-label w-full flex flex-col sm:flex-row">
                    ...
                    <div class="grid grid-cols-2 gap-2 mb-6">
                        <div class="col-span-1 input-form">
                            ...
                            <input id="position" class="form-control" readonly value="{{ $penceramah['position'] }}">
                        </div>
                        <div class="col-span-1 input-form">
                            <label for="register-form-1" class="form-label w-full flex flex-col sm:flex-row">
                                Gred
                            </label>
                            <input id="grade" class="form-control" readonly value="{{ $penceramah['grade'] }}">
                        </div>
                    </div>
                    <div class="input-form mb-6">
                        <label for="register-form-1" class="form-label w-full flex flex-col sm:flex-row">
                        ...
                        <div class="flex flex-col items-start">
                            <div>
                                <input type="radio" id="pmr"
                                    {{ $penceramah['highest_academic'] == "pmr" ? 'checked' : '' }}>
                                <label for="pmr">PMR</label><br>
                            </div>
                            <div>
                                <input type="radio" id="spm"
                                    {{ $penceramah['highest_academic'] == "spm" ? 'checked' : '' }}>
                                <label for="spm">SPM</label><br>
                            </div>
                            <div>
                                <input type="radio" id="stpm"
                                    {{ $penceramah['highest_academic'] == "stpm" ? 'checked' : '' }}>
                    ...
                    <div class="grid grid-cols-2 gap-2 mb-6">
                        <div class="col-span-1 input-form">
                            ...
                            <textarea id="academic_qualification" class="form-control"
                                readonly>{{ $penceramah['academic_qualification'] }}</textarea>
                        </div>
                        <div class="col-span-1 input-form">
                            <label for="register-form-1" class="form-label w-full flex flex-col sm:flex-row">
                                Kelulusan Berniaga
                            ...
                            <textarea id="business_qualification" class="form-control"
                                readonly>{{ $penceramah['business_qualification'] }}</textarea>
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-2 mb-6">
                        <div class="col-span-1 input-form">
                            ...
                            <textarea id="specialisation" class="form-control"
                                readonly>{{ $penceramah['specialisation'] }}</textarea>
                        </div>
                        <div class="col-span-1 input-form">
                            <label for="register-form-1" class="form-label w-full flex flex-col sm:flex-row">
                            ...
                            <textarea id="experience" class="form-control"
                                readonly>{{ $penceramah['experience'] }}</textarea>
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-2 mb-6">
                        <div class="col-span-1 input-form">
                            ...
                            <textarea id="professional_member" class="form-control"
                                readonly>{{ $penceramah['professional_member'] }}</textarea>
                        </div>
                        <div class="col-span-1 input-form">
                            <label for="register-form-1" class="form-label w-full flex flex-col sm:flex-row">
                            ...
                            <textarea id="distribution" class="form-control"
                                readonly>{{ $penceramah['distribution'] }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
