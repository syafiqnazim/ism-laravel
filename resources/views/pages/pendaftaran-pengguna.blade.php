...
@section('subcontent')
<!-- BEGIN: Register Form -->
<h2 class="intro-x font-bold text-2xl xl:text-3xl text-center mt-5">Pendaftaran Pengguna</h2>
        ...
        <div class="intro-x mt-8">
            <form class="register-form">
                <div class="input-form">
                    ...
                    <input id="name" type="text" class="form-control" placeholder="Ahmad Abu" minlength="2" required
                ...
                <div class="input-form mt-3">
                    ...
                    <input id="ic_number" type="number" class="form-control" placeholder="contoh: 123456121234"
                        minlength="12" required data-pristine-required-message="Ruangan ini perlu di isi.">
                </div>
                <div class="input-form mt-3">
                    ...
                    <input id="phone_number" type="number" class="form-control" placeholder="0123456789" minlength="10"
                ...
                <div class="input-form mt-3">
                    ...
                    <input id="position" type="text" class="form-control" placeholder="Pengurus" required
                        data-pristine-required-message="Ruangan ini perlu di isi.">
                </div>
                <div class="input-form mt-3">
                    <label for="register-form-1" class="form-label w-full flex flex-col sm:flex-row">
                    ...
                    <input id="department" type="text" class="form-control" placeholder="Awam" required
                        data-pristine-required-message="Ruangan ini perlu di isi.">
                </div>
                <div class="input-form mt-3">
                    <label for="register-form-1" class="form-label w-full flex flex-col sm:flex-row">
                    ...
                    <select id="user_role" class="sm:ml-auto mt-1 sm:w-full form-select box border-gray-300 py-3">
