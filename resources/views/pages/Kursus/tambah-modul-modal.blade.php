                    ...
                    <div class="p-5 text-center">
                        ...
                        <div class="grid grid-cols-2 gap-2 mb-6">
                            <div class="grid-cols-1 input-form">
                                ...
                                <input id="nama_kursus" name="nama_kursus" type="time" class="form-control timepicker" required
                            ...
                            <div class="grid-cols-1 input-form">
                                ...
                                <input id="kapasiti" name="kapasiti"  type="time" class="form-control timepicker" required
                                    data-pristine-required-message="Ruangan ini perlu di isi.">
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-2 mb-6">
