<!-- BEGIN: Modal Content -->
<div id="datepicker-modal-kenderaan-{{ $loop->index }}" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{url('tempahan-kenderaan/'. $tempahan_kenderaan->id)}}" method="post">
            @csrf
            ...
            <div class="modal-content">
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 sm:col-span-6">
                        ...
                        @if($tempahan_kenderaan->tarikh_mula)
                        <input id="modal-datepicker-1" class="datepicker form-control" data-single-mode="true"
                            name="tarikh_mula" value="{{ $tempahan_kenderaan->tarikh_mula }}">
                        @else
                        <input id="modal-datepicker-1" class="datepicker form-control" data-single-mode="true"
                            name="tarikh_mula">
                        @endif
                    ...
                    <div class="col-span-12 sm:col-span-6">
                        ...
                        @if($tempahan_kenderaan->tarikh_akhir)
                        <input id="modal-datepicker-1" class="datepicker form-control" data-single-mode="true"
                            name="tarikh_akhir" value="{{ $tempahan_kenderaan->tarikh_akhir }}">
                        @else
                        <input id="modal-datepicker-1" class="datepicker form-control" data-single-mode="true"
                            name="tarikh_akhir">
                        @endif
